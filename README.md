...
- [Phase 5.2E independent review and reconciliation acceptance](docs/phase-5-2e-acceptance.md)
- [Phase 5.2F bounded repair, recovery, and promotion acceptance](docs/phase-5-2f-acceptance.md)
- [Phase 5.3A evaluation lifecycle boundary acceptance](docs/phase-5-3a-acceptance.md)
- [Phase 5.3B evaluation pipeline boundary acceptance](docs/phase-5-3b-acceptance.md)
- [Phase 5.3C evaluation campaign and read-model acceptance](docs/phase-5-3c-acceptance.md)
- [Phase 5.3D workflow and task boundary acceptance](docs/phase-5-3d-acceptance.md)
...
- [Phase 5.5A reusable operator workflow acceptance](docs/phase-5-5a-acceptance.md)
- [Phase 5.5B live operator feedback and negative-review acceptance](docs/phase-5-5b-acceptance.md)
- [Reusable manifest-bound operator workflows](docs/operator-workflows.md)
